# dima_miniapp2.0-11-25-

## Инициализация Git репозитория

Для инициализации и настройки Git репозитория выполните следующие команды:

```bash
echo "# dima_miniapp2.0-11-25-" >> README.md
git init
git add README.md
git commit -m "first commit"
git branch -M main
git remote add origin https://github.com/Qantemir/dima_miniapp2.0-11-25-.git
...
Changes made via Lovable will be saved automatically.

**Use your preferred IDE**

If you want to work locally using your own IDE, you can work with the project files directly.
